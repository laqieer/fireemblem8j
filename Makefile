...
src/ReadSramFast_Core.o src/WriteSramFast.o src/VerifySramFast_Core.o: CC1FLAGS := -mthumb-interwork -Wimplicit -Wparentheses -Werror -O1 -fhex-asm -ffix-debug-line -g
