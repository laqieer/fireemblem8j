    ...
    .section .data
    .INCLUDE "gba.inc"
    @ FE6 SIO multiboot block. The data is the same across FE7/FE8 regions.
    @ FE8J: 0x08BB310C ~ +0x567C (placed via ldscript.txt / layout/carved_rom)
    @ FE8U: 0x00B1A0B8 ~ +0x567C
    @ FE7J: 0x00DC4FBC ~ +0x567C
