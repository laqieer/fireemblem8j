	...
	.section .text.sub_80B933C, "ax", %progbits
@ sub_80B933C @ JP 0x080B933C - region-different, gbadisasm descriptive asm (D23)
	.thumb
	.global sub_80B933C
	.thumb_func
sub_80B933C:
...
_080B93B8:
	...
	b _080B94AE
	.align 2, 0
_080B93E8: .4byte 0x085775CC
_080B93EC:
	ldr r0, _080B9424 @ =0x085775CC
	ldr r0, [r0]
	ldrh r1, [r0, #8]
	movs r0, #0x80
	lsls r0, r0, #1
...
_080B9460:
	...
	b _080B94AE
	.align 2, 0
_080B9488: .4byte 0x00000855
_080B948C:
	movs r0, #2
	ands r0, r1
	cmp r0, #0
	beq _080B94AE
	ldr r0, _080B94B4 @ =0x0202BCEC
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
