...
> `DecodeLinkArenaRecordHeader` (`sub_80A6D34`) matched through FE6J/FE7J
> cross-version block alignment plus P14 two-address accumulator steering.
> `9myLi` is SOLVED at raw score 0 and its registry row is retired.
>
> **[HISTORICAL UPDATE — axis-2 was 7 still-asm (matching-C 99.92%, 8685/8692).]**
...
- RegisterTsaWithOffset, GmapScreen2_Loop, PutFaceOnBackGround,
  sub_800A34C (spline 534/584), sub_80A6F1C, and sub_800A594.
  ...
  have matched and are no longer queue entries. `sub_80A6D34` joined them on
  2026-07-11 via deterministic FE6J/FE7J alignment + P14.]
