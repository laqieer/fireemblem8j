...
> The fe8u oracle commits exactly **1381** binaries, all `*.tsa.bin` / `*.map.bin` / the `fe6sio_payload` — so any fe8j `.bin` with an editable fe8u twin is a true MISS.
...
| TSA/.map.bin | FLOOR | 1298 | fe8u keeps TSA/tilemaps binary too |
...
| ApConf/opaque | UNCERTAIN | 0 | fe8u form unclear — DEFERRED, needs RE |
...
`frontier_df4_misc_lo` strings as floor — the chapter-title **images** and the
string pools are MISSES, listed under MISS; the chapter-title **string TSA**
companion (`gChapterTitleStrTsa_jp`, `frontier_chap_title_115b_A92410.bin`) is a
genuine FLOOR — all asserted by the self-test guards below).
...
- `graphics/frontier_df4_ending/frontier_df4_ending_007_residual_B381.bin` → **FLOOR** (pixel-gfx) — proof: evidence-backed FLOOR: 519 B near-zero residual (only first 8 B non-zero), no pointer structure, no known consumer -- narrowly scoped raw floor (#143, D377)
...
## FLOOR (1452) — fe8u also keeps these binary — legitimate; do NOT fake-extract.

<details><summary>1452 entries</summary>
...
| `graphics/banim_efx_bg/data_08613A6C_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_08613A6C_1.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_08616558_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_0861CCC0_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_08630AD8_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_08636008_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_0864CAC8_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_086724CC_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_086724CC_1.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_086724CC_2.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_0867B54C_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_0867B54C_1.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_086AC554_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_086AC554_1.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_086BAB74_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_086BAB74_1.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_087644A8_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/banim_efx_bg/data_08764BF4_0.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
...
| `graphics/frontier_banim_aurabg3/frontier_banim_aurabg3_016a_7767BC.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
...
| `graphics/frontier_banim_aurabg3/frontier_banim_aurabg3_028a_777858.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
...
| `graphics/frontier_banim_dracozombie/frontier_banim_dracozombie_017a_78048C.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
...
| `graphics/frontier_banim_dracozombie/frontier_banim_dracozombie_036a_78EE00.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
...
| `graphics/frontier_banim_dracozombie/frontier_banim_dracozombie_040a_7955B8.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_chap_title/frontier_chap_title_115b_A92410.bin` | TSA/.map.bin | fe8u keeps BG-overlay TSA tilemaps binary (`*.tsa.bin` / `assets/tsa/*.map.bin`) — sparse tile-arrangement (blank-tile fill), not pixel gfx |
| `graphics/frontier_df3_banim_aura/data_0874687C.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/frontier_df3_banim_aura/data_08746D0C.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/frontier_df3_banim_aura/data_087471A8.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/frontier_df3_banim_aura/data_087548F0.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_aura/data_087549F8.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_aura/data_08754B34.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_aura/data_08754CA8.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_aura/data_08754E40.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_aura/data_08754FB4.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_aura/data_087550C0.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_aura/data_08755194.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_aura/frontier_df3_banim_aura_000a_7463DC.map.bin` | TSA/.map.bin | fe8u keeps .map.bin binary (TSA/tilemap) |
| `graphics/frontier_df3_banim_aura/frontier_df3_banim_aura_003a_754840.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000a_64D2B4.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000b_64D3C8.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000c_64D478.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000d_64D580.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000e_64D6BC.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000f_64D830.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000g_64D9C8.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000h_64DB3C.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000i_64DC48.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_000j_64DD1C.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_008a_657A78.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_008b_657B20.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_008c_657BDC.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_008d_657CB4.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_008e_657D94.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009a_6587E0.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009b_658880.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009c_658934.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009d_6589F0.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009e_658ACC.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009f_658BB4.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009g_658CD8.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009h_658DF8.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009i_658F04.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df3_banim_mid/frontier_df3_banim_mid_009j_659010.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
...
| `graphics/frontier_df4_banim_b/data_08706114.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df4_banim_b
map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
| `graphics/frontier_df4_banim_b/frontier_df4_banim_b_056c_7659D4.map.bin` | TSA/.map.bin | fe8u keeps banim/bg screen tilemaps (30x20 u16 TSA) binary (`assets/tsa/*.map.bin`) |
...
| `graphics/frontier_df4_ending/frontier_df4_ending_007_residual_B381.bin` | pixel-gfx | evidence-backed FLOOR: 519 B near-zero residual (only first 8 B non-zero), no pointer structure, no known consumer -- narrowly scoped raw floor (#143, D377) |
| `graphics/frontier_df4_ending/frontier_df4_ending_007_s0.tsa.bin` | TSA/.map.bin | fe8u keeps .tsa.bin binary (TSA/tilemap) |
| `graphics/frontier_df4_ending/frontier_df4_ending_007_s1.tsa.bin` | TSA/.map.bin | fe8u keeps .tsa.bin binary (TSA/tilemap) |
| `graphics/frontier_df4_ending/gTsa_DfEnding008.tsa.bin` | TSA/.map.bin | fe8u keeps this TSA/tilemap binary (`*.tsa.bin` / `*.map.bin`) |
| `graphics/frontier_df4_ending/gUnk_08AC718C.tsa.bin` | TSA/.map.bin | fe8u keeps .tsa.bin binary (TSA/tilemap) |
...
| `graphics/frontier_df4_menu/frontier_df4_menu_001_A588C0_head_tsa.tsa.bin` | TSA/.map.bin | fe8u keeps .tsa.bin binary (TSA/tilemap) |
...
| `graphics/frontier_df4_uistuff/Tsa_Sub8022200.tsa.bin` | TSA/.map.bin | fe8u keeps this TSA/tilemap binary (`*.tsa.bin` / `*.map.bin`) |
| `graphics/frontier_df4_uistuff/Tsa_sub_8021AFC.tsa.bin` | TSA/.map.bin | fe8u keeps this TSA/tilemap binary (`*.tsa.bin` / `*.map.bin`) |
...
| `graphics/frontier_ending_cg/frontier_ending_cg_pad_B352D4.bin` | pixel-gfx | RE-COMPLETE evidence-backed floor: exact 24-byte partial 4bpp fragment between 647 complete tiles and a 30x20 TSA map; no symbol, relocation, xref, or fe8u semantic twin, and neither a semantic u16 table nor CreditsCG-indexed data (issue #143) |
...
| `graphics/misc_gfx2/Tsa_GameIntroNintendo.bin` | TSA/.map.bin | fe8u keeps this TSA/tilemap binary (`*.tsa.bin` / `*.map.bin`) |
...
| `graphics/misc_gfx2/Tsa_StaffReelEnt_6.bin` | TSA/.map.bin | fe8u keeps this TSA/tilemap binary (`*.tsa.bin` / `*.map.bin`) |
| `graphics/misc_gfx2/Tsa_StaffReelEnt_7.bin` | TSA/.map.bin | fe8u keeps this TSA/tilemap binary (`*.tsa.bin` / `*.map.bin`) |
...
| `graphics/misc_gfx2/gTsa_OpSubtitle_02.bin` | TSA/.map.bin | fe8u keeps this TSA/tilemap binary (`*.tsa.bin` / `*.map.bin`) |
...
| `graphics/misc_gfx2/gTsa_OpSubtitle_05.bin` | TSA/.map.bin | fe8u keeps this TSA/tilemap binary (`*.tsa.bin` / `*.map.bin`) |
| `graphics/misc_gfx2/gTsa_OpSubtitle_06.tsa.bin` | TSA/.map.bin | fe8u keeps this TSA/tilemap binary (`*.tsa.bin` / `*.map.bin`) |
...
| `graphics/misc_gfx2/gWorldmapMinimap_6.tsa.bin` | TSA/.map.bin | fe8u keeps .tsa.bin binary (TSA/tilemap) |
| `graphics/misc_gfx2/gWorldmapSkirmish_1.tsa.bin` | TSA/.map.bin | fe8u keeps .tsa.bin binary (TSA/tilemap) |
...
## UNCERTAIN (0) — fe8u form unknown — DEFERRED, needs RE; document, don't fake.
