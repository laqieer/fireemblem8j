...
## D70 — MC-permuter PILOT: decomp-permuter VALIDATED on FAR codegen; +5 carved; but the small-FAR tail is dominated by JP DATA-CONSTANT diffs the permuter CANNOT solve (2026-06-12)
