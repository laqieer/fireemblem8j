...
## D60 — h3: the no-funcmap worklist harvest via per-FUNCTION direct carve (perfrag_carve.py); +67 across 3 TUs; fontgrp is whole-TU region-DIFFERENT codegen (2026-06-11)
