...
## D70 — typed-data: gItemData[206] + its pointee tables (data_itemuse/data_itembonus) carved to typed C; +7,940 B extracted, broke the "pointer-heavy struct table" frontier D55 flagged (2026-06-12)
