...
| 2 | Matching-C | **99.95% (8688/8692)** | 8561 `src/*.c` + 127 libc/libgcc real source; **4 still descriptive asm**. The five-function D369 harvest, D370 `DecodeAndVerifyArenaRecord`, the serialized `DecodeLinkArenaRecordHeader` P14 promotion, and the `sub_800FAD0` P14 promotion move the 22-function cohort to **4**. |
...
> requirement. The decisive P14 shape keeps arg2 direct, widens the stacked
