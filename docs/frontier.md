...
- **Historical snapshot (superseded by D368 below): pointer-debt COMPLETION GATE = 1**
  ...
  **[CORRECTED + HARD-GATED by D376, 2026-07-13: D363's
  ...
  **8 evidence-resolved symbols / 267 exact hit words**: four validated GBA-LZ
  ...
  fully closed. See decisions.md **D376**.]**
...
| 5 | Shiftability | **exact-extent gate 0; unresolved=0** | D368's shifted-ROM proof keeps the issue #166 banim residual closed. D376 hard-gates the exact-extent opaque self-ref review: **8 evidence-resolved symbols / 267 exact embedded-data hit words / 0 unresolved**; `sBanimEkrPopupProcNames` has an independently proven `0x178` provider with zero hits. The gate does **not** cover 1,074 zero-size opaque labels (865 `AnimSprite_*`); no repository-wide self-ref backstop currently covers that population. The old stretched scan found no additional rows, but that is not a completeness proof. Issue #143 remains open. See **D368/D376**. |
