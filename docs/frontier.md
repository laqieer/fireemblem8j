...
| 2 | Matching-C | **99.93% (8686/8692)** | 8559 `src/*.c` + 127 libc/libgcc real source; **6 still descriptive asm**. The five-function D369 harvest plus the D370 `DecodeAndVerifyArenaRecord` landing move the 22-function cohort to **6**. |
...
> **Code-byte companion (frogress/decomp.dev `code` measure, source-form):** **99.69%** (898,664 / 901,428 bytes); **0.31% = 2,764 bytes** remains descriptive asm. Verbatim from `python3 scripts/calcprogress.py`; see D343/D369/D370.
