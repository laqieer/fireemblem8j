...
### Proven false ABS32 decodes — function interior + semantic domains fixed and gated (#143 follow-up, D377, 2026-07-13/14)
...
| 5 | Shiftability | **gate 0; proven false-ABS32 classes enforced** | D368 closed the issue-#166 banim residual. D377 removed `gWorldmapRadar_1` plus seventeen semantic false relocations, including all **12/12** relocations resolving inside the cartridge header. Layer 1d gates function interiors, packed scalars, compressed/nested-image address domains, and unaudited header targets. Post-fix: **59,485 ROM ABS32, 5,678 FUNC targets, 0 interiors, 0 header-domain relocations, 0 scalar failures**; dedicated `+0x40000` A/B checked **5,678/5,678** legitimate function entries. This is a #143 follow-up, not a claim that #143 is fully closed. |
