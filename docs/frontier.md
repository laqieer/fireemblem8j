...
- **MATCHING-C: 99.99%** (8527/8528 funcs by the US-count metric — ONE from metric-100%) → **+190 net session**. By CODE BYTES: **95.93% in src (4.07% = 36,728 bytes across 54 functions still descriptive asm)**. The ALL-LEVERS re-examination campaign hit **8/14 (57%)** — definitively proving the "reg-coloring ceiling" verdicts were mass-wrong: PutUnitSpriteIconsOam/Tactician_InitScreen/ClassIntro_Init/OpAnimFaceMontageBegin + 4 more, all via -mjp-promote + identity-rederive + named-bitfields + register-pins. Batch 2 (14 largest, incl sub_8057F80 2936B) running. Earlier this session:
