...
6. **sub_8057F80** — PrepareBattleGraphicsMaybe; genuinely region-different (2936B region-diff); a byte match is out of scope (STRETCH-only permuter). — decomp.me: https://decomp.me/scratch/WHtsM (start here to help match; WIP scratch, not a solved match).
