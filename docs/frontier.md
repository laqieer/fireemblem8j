...
| 4 | Named symbols | **96.97% (12,253/12,636)** | **383** placeholders; DATA-residue-split waves named catch-all `data_` blobs into fe8u-validated sub-objects (EventListScr/AnimScr/AnimSprite/REDA/UnitDefinition/EventScr), passing the earlier ~95.8% reachable-max estimate; `banim_`/`gfx_`/`snd_` remain fe8u-auto-named → structurally < 100%. |
