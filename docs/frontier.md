...
| 2 | Matching-C | **99.93% (8686/8692)** | 8559 `src/*.c` + 127 libc/libgcc real source; **6 still descriptive asm**. The `sub_800FAD0` P23 candidate moves the 22-function cohort to **6**. |
...
> The decisive P23 shape widens the stacked fifth argument to ABI `int`, delays
