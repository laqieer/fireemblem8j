...
- **MATCHING-C: 99.49%** (8639/8683 JP funcs; **44 still descriptive asm / 39 named**). **D288 real-source + lib-link sweep (+7 this segment)** by re-applying the D287-CORRECTION mindset (re-verify every "confirmed-hard" verdict, don't trust it):
