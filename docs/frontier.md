...
| 5 | Shiftability | **gate 0; opaque self-ref unresolved=0** | D368's shifted-ROM proof keeps the issue #166 banim residual closed. D376 now hard-gates the separate opaque self-ref review: **8 evidence-resolved symbols / 267 exact embedded-data hit words / 0 unresolved**; `sBanimEkrPopupProcNames` is absent because its exact `0x178` provider has zero hits. Any new candidate or evidence drift fails `make shiftcheck`. This does not claim issue #143 fully closed. See **D368/D376**. |
