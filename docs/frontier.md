...
- **Historical snapshot (superseded by D368 below): pointer-debt COMPLETION GATE = 1**
  ...
  **8 evidence-resolved symbols / 267 exact hit words**: four validated GBA-LZ
  ...
  fully closed. See decisions.md **D378**.]**
...
### Proven false ABS32 decodes — function interior + packed scalars fixed and gated (#143 follow-up, D380, 2026-07-13)
...
The follow-up removed thirteen more proven scalar relocations: eight TileAnimations3
...
`gLegacyUiFrameDImage` and 2,950 in the DarkBreath stream. The live JP
...
placement anchors remain REVIEW-only. Final counts are **59,489 ROM ABS32,
5,678 FUNC targets, 0 function interiors, 0 large-addend semantic failures,
0 compressed-anchor failures, 0 AREA-scalar failures, and 0 header-scalar
failures**. This completes only these proven
