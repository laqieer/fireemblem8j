...
> **Code-byte companion (frogress/decomp.dev `code` measure, source-form):** **99.72%** (898,944 / 901,428 bytes); **0.28% = 2,484 bytes** remains descriptive asm. Verbatim from `python3 scripts/calcprogress.py`; see D343/D369/D370/D371.
