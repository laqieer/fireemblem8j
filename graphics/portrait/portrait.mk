...
#
# src/data/portrait/data_portrait.c INCBIN_U8s 482 portrait assets (region-SAME
# with US, JP 0x08861950 == US 0x0880d3f8, 653288B). Per asset class:
...
# dep list from the committed PNGs by class.
...
src/data/portrait/data_portrait.o: $(PORTRAIT_MOUTH_4BPP) $(PORTRAIT_CHIBI_LZ) $(PORTRAIT_CARD_LZ) $(PORTRAIT_TILESET_FK)
