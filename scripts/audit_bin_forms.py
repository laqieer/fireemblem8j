...
NAME_CLASS_RULES = [
    ...
    # a FALSE floor (D383/D384): an over-large decompression window hid a true
...
# here: it was a FALSE floor (D383/D384) -- fully sourceable, no longer a raw #
# file at all.                                                                #
# --------------------------------------------------------------------------- #
...
def run_self_tests(by_path):
    ...
    # here: it was a false floor (D383/D384), now fully typed/editable with no
    ...
    if any("frontier_df4_menu_001_A588C0.bin" in p for p in by_path):
        failures.append("frontier_df4_menu_001_A588C0.bin still tracked as a "
                        ...
                        "editable with zero raw bytes remaining (D383/D384)")
