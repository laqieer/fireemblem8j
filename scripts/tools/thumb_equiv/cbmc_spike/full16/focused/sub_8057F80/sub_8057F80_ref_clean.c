...
s32 PrepareBattleGraphicsMaybe(void) {
    ...
    temp_r2 = 0x10 & *(u32 *)0x0203A4D0;
    if (temp_r2 != 0) {
        *(u16 *)0x0203E11C = 4;
        var_r8 = (s16 *)0x0203E11C;
    } else {
        *(u32 *)0x0203E11C = temp_r2;
        var_r8 = (s16 *)0x0203E11C;
    }
    if ((s16) *(s16 *)0x0203E11C == 4) {
        ...
        *(s32 *)0x0203E188 = 0x0203A568;
        ...
        if ((0x40 & *(u32 *)0x0203A4D0) || (M2C_FIELD((void *)0x0203A4E8, u16 *, 0x4A) == 0)) {
            var_r6 = 2;
        } else {
        ...
        if (var_r4_2 == 1) {
            *(u32 *)0x0203E184 = 0x0203A568;
            sp8 = (void *)0x0203A568;
            *(u32 *)0x0203E188 = 0x0203A4E8;
            spC = (void *)0x0203A4E8;
            ...
            *(u32 *)0x0203E184 = 0x0203A4E8;
            sp8 = (void *)0x0203A4E8;
            *(u32 *)0x0203E188 = 0x0203A568;
            spC = (void *)0x0203A568;
            M2C_FIELD((void *)0x0203E104, s16 *, 0) = 0;
    ...
    if (temp_r1 != 0) {
        M2C_FIELD((void *)0x0203E11E, s16 *, 4) = (s16) ((s32) ((M2C_FIELD(sp18, s8 *, 0x10) * 0x10) - *(u32 *)0x0202BCB8) >> 4);
        M2C_FIELD((void *)0x0203E11E, s16 *, 6) = (s16) ((s32) ((M2C_FIELD(sp18, s8 *, 0x11) * 0x10) - *(u32 *)0x0202BCBA) >> 4);
    }
    if ((s16) *(s16 *)0x0203E11C != 4) {
...
loop_67:
    ...
    *(s16 *)0x0203E0FE = var_r0_4;
    ...
    if ((s16) *(u32 *)0x0203E11C == 4) {
        ...
        if ((0x40 & *(u32 *)0x0203A4D0) && ((IsItemDisplayedInBattle(M2C_FIELD(spC, u16 *, 0x4A)) << 0x10) == 0) && (M2C_FIELD(M2C_FIELD(sp18, void **, 4), u8 *, 4) == 0x4D)) {
