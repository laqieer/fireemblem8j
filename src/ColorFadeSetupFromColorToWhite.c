 ...
 * definition below. */
#define ColorFadeSetupFromColorToWhite ColorFadeSetupFromColorToWhite_u8_proto_hidden
#include "global.h"
#include "proc.h"
#include "bm.h"
#include "ctc.h"
#include "hardware.h"
#undef ColorFadeSetupFromColorToWhite

// duplicate of ColorFadeSetupFromColorToBlack
void ColorFadeSetupFromColorToWhite(short a)
{
    int i;
    int j;
    u8 new_var;
