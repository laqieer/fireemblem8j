...
// JP (BE8J) region difference: the US ROM lists { CHARACTER_NATASHA(0x0D), 0, 0, 0 }
// here, but the JP ROM holds { 0x00, 0x01, 0x00, 0x00 } at 0x085D2908 — a different
// character-exclusion list. Matched to the JP bytes (make compare is the oracle).
u8 CONST_DATA gCpData_33[] = { 0x00, 0x01, 0x00, 0x00 };

// 0x07 = Action in range, ignoring a fixed character list (gCpData_33).
