...
/* Migrated from asm/dat_data_5B65C0_p0.s (region-same graphics, single section).
 * Each symbol kept in the original section/order; byte-identical via INCBIN_U*.
 */

SECTION(".rodata.dat_data_5B65C0_p0") const u8 gUiFrameImage[] = INCBIN_U8("graphics/reuse/gUiFrameImage.4bpp.lz");
