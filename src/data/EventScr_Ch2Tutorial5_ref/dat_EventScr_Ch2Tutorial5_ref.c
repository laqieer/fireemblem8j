...
/* Converted from ../../../../../../tmp/orig_EventScr_Ch2Tutorial5.c by scripts/eventscr_disasm.py (D309).
...
SECTION(".rodata.dat_EventScr_Ch2Tutorial5_ref") EventListScr EventScr_Ch2Tutorial5[] = {
    EVBIT_T(7)
    IGNORE_KEYS(0)
    SVAL(EVT_SLOT_D, 0)
