...
extern struct REDA REDAs_UnitDef_Ch21BMixed_0[];
SECTION(".rodata.dat_UnitDef_Ch21BMixed_ref") struct UnitDefinition UnitDef_Ch21BMixed[] =
{
    ...
    { .charIndex=0xF, .classIndex=0x1, .level=0x1, .xPosition=0xB, .yPosition=0x4, .redaCount=0x1, .redas=REDAs_UnitDef_Ch21BMixed_0 },
