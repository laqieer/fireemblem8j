.section .rodata.dat_anim_085A0EA0,"aw"

@ gUnkData_2 / g085A0EA0: editable AP-motion source for the warp/prep unit-swap
@ cursor animation (AP_Create(gUnkData_2, 0), cf WarpSelect_OnInit.c /
@ PrepScreen_StartUnitSwap.c). Region-same: byte-identical to fe8u
@ src/data/ui/anim_085A0EA0.s (verified: that .s assembles to the exact JP ROM
@ blob at 0x085C93C0, formerly 11 split data/residual/g085A0EA0_*.bin INCBINs).
