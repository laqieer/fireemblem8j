...
u16 Img_WmHightLightMapFrecia[] __attribute__((section(".rodata.dat_anim_worldmap_highlight"))) = INCBIN_U16("graphics/misc_gfx3/Img_WmHightLightMapFrecia.4bpp.lz");
...
u16 Img_WmHightLightMap2[] __attribute__((section(".rodata.dat_anim_worldmap_highlight"))) = INCBIN_U16("graphics/misc_gfx3/Img_WmHightLightMap2.4bpp.lz");
