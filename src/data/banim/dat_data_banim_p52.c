...
SECTION(".rodata.dat_data_banim_p52") u8 AnimSprite_EfxMantBatabata2_L_3[] = INCBIN_U8("data/residual/AnimSprite_EfxMantBatabata2_L_3.bin");
SECTION(".rodata.dat_data_banim_p52") u8 AnimSprite_EfxMantBatabata2_L_4[] = INCBIN_U8("data/residual/AnimSprite_EfxMantBatabata2_L_4.bin");
