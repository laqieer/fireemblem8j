...
SECTION(".rodata.dat_banim_efxhitobj") u16 Tsa4_EfxPierceNormalEffectBG[] = INCBIN_U16("graphics/banim/efxhitobj/Tsa4_EfxPierceNormalEffectBG.map.bin.lz");
SECTION(".rodata.dat_banim_efxhitobj") u16 Tsa5_EfxPierceNormalEffectBG[] = INCBIN_U16("graphics/banim/efxhitobj/Tsa5_EfxPierceNormalEffectBG.map.bin.lz");
SECTION(".rodata.dat_banim_efxhitobj") u16 Tsa6_EfxPierceNormalEffectBG[] = INCBIN_U16("graphics/banim/efxhitobj/Tsa6_EfxPierceNormalEffectBG.map.bin.lz");
SECTION(".rodata.dat_banim_efxhitobj") u16 Tsa7_EfxPierceNormalEffectBG[] = INCBIN_U16("graphics/banim/efxhitobj/Tsa7_EfxPierceNormalEffectBG.map.bin.lz");
SECTION(".rodata.dat_banim_efxhitobj") u16 Tsa8_EfxPierceNormalEffectBG[] = INCBIN_U16("graphics/banim/efxhitobj/Tsa8_EfxPierceNormalEffectBG.map.bin.lz");
SECTION(".rodata.dat_banim_efxhitobj") u16 Tsa9_EfxPierceNormalEffectBG[] = INCBIN_U16("graphics/banim/efxhitobj/Tsa9_EfxPierceNormalEffectBG.map.bin.lz");
SECTION(".rodata.dat_banim_efxhitobj") u16 TsaA_EfxPierceNormalEffectBG[] = INCBIN_U16("graphics/banim/dragonfx/Tsa_87932EC.map.bin.lz");
