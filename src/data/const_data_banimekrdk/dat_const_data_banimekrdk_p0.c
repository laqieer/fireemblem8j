...
/* Migrated from asm/dat_const_data_banimekrdk_p0.s (region-same graphics, single section).
...
SECTION(".rodata.dat_const_data_banimekrdk_p0") u8 Tsa_ConstDataBanimekrdk_0[] = INCBIN_U8("graphics/reuse/Tsa_ConstDataBanimekrdk_0.4bpp.lz");
