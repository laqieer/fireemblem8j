 ...
 * Baseline AnimScr_* aliases into this table: AnimScr_EfxSunakemuriOBJ2_L
 */

extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ2_L_1[];
extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ2_L_2[];
extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ2_L_3[];
extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ2_L_4[];

u32 data_0861E4D4[] __attribute__((section(".data.residue.0861E4D4"))) =
{
