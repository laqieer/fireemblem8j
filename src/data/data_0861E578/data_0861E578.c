 ...
 * Baseline AnimScr_* aliases into this table: AnimScr_EfxSunakemuriOBJ3_R
 */

extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ3_R_1[];
extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ3_R_2[];
extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ3_R_3[];
extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ3_R_4[];

u32 data_0861E578[] __attribute__((section(".data.residue.0861E578"))) =
{
