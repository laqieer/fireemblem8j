 ...
 * Baseline AnimScr_* aliases into this table: AnimScr_EfxSunakemuriOBJ3_L
 */

extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ3_L_1[];
extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ3_L_2[];
extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ3_L_3[];
extern struct AnimSpriteData AnimSprite_EfxSunakemuriOBJ3_L_4[];

u32 data_0861E61C[] __attribute__((section(".data.residue.0861E61C"))) =
{
