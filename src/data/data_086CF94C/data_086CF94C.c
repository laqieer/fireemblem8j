...
u32 data_086CF94C[] __attribute__((section(".data.residue.086CF94C"))) = {
    0x80000000,
    0xFFF0000C,
    0x0000FFF0,
    0x00000001,
...
u32 AnimScr_EfxDarkGradoOBJ02piece2_R[] __attribute__((section(".data.residue.086CF94C"))) = {
    (u32)&data_086CF94C + 0x1,
    (u32)&data_086CF94C + 0x19,
    (u32)&data_086CF94C + 0x31,
    (u32)&data_086CF94C + 0x19,
    0x82000000,
    0xFFFF0001,
    0x0000FF80,
    ...
    0x00000000,
    0x00000000,
    (u32)&data_086CF94C + 0x71,
    (u32)&data_086CF94C + 0x95,
    (u32)&data_086CF94C + 0xB9,
    (u32)&data_086CF94C + 0x95,
    0x82000000,
    (u32)&data_086CF94C + 0xDD,
    (u32)&data_086CF94C + 0xF5,
    (u32)&data_086CF94C + 0x10D,
    (u32)&data_086CF94C + 0xF5,
    0x82000000,
};
