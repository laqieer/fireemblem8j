...
u8 frontier_df3_ending_000_AC1BC0[] __attribute__((section(".data.frontier_df3_ending.gap0"))) = INCBIN_U8("graphics/frontier_df3_ending/frontier_df3_ending_000_AC1BC0.bin", 0x0, 0x950);
u8 data_08AC2510[] __attribute__((section(".data.frontier_df3_ending.gap0"))) = INCBIN_U8("graphics/frontier_df3_ending/frontier_df3_ending_000_AC1BC0.bin", 0x950, 0x6D0);
