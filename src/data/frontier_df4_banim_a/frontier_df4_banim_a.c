...
u8 frontier_df4_banim_a_014_601CD8[] __attribute__((section(".data.frontier_df4_banim_a.gap14"))) = INCBIN_U8("graphics/frontier_df4_banim_a/frontier_df4_banim_a_014_601CD8.bin");
