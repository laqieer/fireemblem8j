...
/* frontier_df4_menu_038_ABCD24 [0,0x20): gProcScr_ArenaUiResultBgm, carved into
 * src/uiarena.c as a real ProcCmd[4] (issue #143 menu pass). The former
 * [0x20,end) "descriptor table" (also covering the rest of blob038 and all of
 * blob039 up to the gamerankings tables) is the JP world-map EventScr family,
 * now fully migrated to src/events_wm.c (issue #143 menu pass, Phase C). This
 * frontier_df4_menu.o gap38b/gap39 ownership ends here; see
 * layout/carved_rom.d/data_frontier4_df4_menu.tsv for the exact address split. */
