...
__asm__(
    ...
    ".4byte 0x00000000\n"
    ".4byte 0x00000003\n"
    ".4byte EventDisplayCursor_Loop\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000003\n"
    ".4byte ScriptBattleDeamon\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000003\n"
...
"\t.4byte LockGame\n"
"\t.4byte 0x00000002\n"
"\t.4byte SpacialSeTest_OnInit\n"
"\t.4byte 0x00000003\n"
"\t.4byte SpacialSeTest_OnLoop\n"
"\t.4byte 0x000A000F\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000003\n"
"\t.4byte PalFade_OnLoop\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000002\n"
"\t.4byte FadeToBlack_OnInit\n"
"\t.4byte 0x0000000E\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000003\n"
"\t.4byte FadeToCommon_OnLoop\n"
"\t.4byte 0x00000010\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000002\n"
"\t.4byte FadeFromBlack_OnInit\n"
"\t.4byte 0x0000000E\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000003\n"
"\t.4byte FadeFromCommon_OnLoop\n"
"\t.4byte 0x00000010\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000002\n"
"\t.4byte FadeToWhite_OnInit\n"
"\t.4byte 0x0000000E\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000003\n"
"\t.4byte FadeToCommon_OnLoop\n"
...
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000003\n"
"\t.4byte TemporaryLock_OnLoop\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00004F82\n"
"\t.4byte 0x00005B81\n"
"\t.4byte 0x00000003\n"
"\t.4byte PaletteAnimator_Loop\n"
"\t.4byte 0x00000003\n"
"\t.4byte CallDelayed_OnLoop\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000003\n"
...
__asm__(
    ...
    ".4byte 0x00000002\n"
    ".4byte StartPlayerPhaseStartTutorialEvent\n"
    ".4byte 0x00000014\n"
    ".4byte EventEngineExists\n"
    ".4byte 0x00000002\n"
    ".4byte PlayerPhase_HandleAutoEnd\n"
    ".4byte 0x00000002\n"
    ".4byte StartMapSongBgm\n"
    ".4byte 0x0009000b\n"
    ".4byte 0x00000000\n"
    ...
    ".4byte 0x00000002\n"
    ".4byte ResetUnitSpriteHover\n"
    ".4byte 0x00000003\n"
    ".4byte PlayerPhase_MainIdle\n"
    ".4byte 0x0001000b\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000002\n"
    ...
    ".4byte 0x00000002\n"
    ".4byte SetAllUnitNotBackSprite\n"
    ".4byte 0x00000002\n"
    ".4byte RefreshUnitSprites\n"
    ".4byte 0x00010006\n"
    ".4byte gProcScr_PlayerPhase + 0x210\n"
    ".4byte 0x00000002\n"
    ".4byte PlayerPhase_InitUnitMovementSelect\n"
    ".4byte 0x0001000e\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000003\n"
    ".4byte PlayerPhase_RangeDisplayIdle\n"
    ".4byte 0x00000002\n"
    ".4byte PlayerPhase_DisplayUnitMovement\n"
    ".4byte 0x00000003\n"
    ".4byte PlayerPhase_WaitForUnitMovement\n"
    ".4byte 0x0002000b\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000003\n"
    ".4byte PlayerPhase_ApplyUnitMovement\n"
    ".4byte 0x0007000b\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000008\n"
    ".4byte ProcScr_CamMove\n"
    ".4byte 0x00000016\n"
    ".4byte PlayerPhase_PrepareAction\n"
    ".4byte 0x00000016\n"
    ".4byte ApplyUnitAction\n"
    ".4byte 0x00000016\n"
    ".4byte HandlePostActionTraps\n"
    ".4byte 0x00000016\n"
    ".4byte RunPotentialWaitEvents\n"
    ".4byte 0x00000016\n"
    ".4byte EnsureCameraOntoActiveUnitPosition\n"
    ".4byte 0x00000002\n"
    ".4byte PlayerPhase_FinishAction\n"
    ".4byte 0x0000000c\n"
    ".4byte 0x00000000\n"
    ".4byte 0x0004000b\n"
    ".4byte 0x00000000\n"
    ...
    ".4byte 0x00000000\n"
    ".4byte 0x00000002\n"
    ".4byte PlayerPhase_ReReadGameSaveGfx\n"
    ".4byte 0x000a000b\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00010006\n"
    ...
    ".4byte 0x00000000\n"
    ".4byte 0x00000002\n"
    ".4byte PlayerPhase_ResumeRangeDisplay\n"
    ".4byte 0x0001000c\n"
    ".4byte 0x00000000\n"
    ".4byte 0x0008000b\n"
    ".4byte 0x00000000\n"
    ...
    ".4byte 0x00000000\n"
    ".4byte 0x00000002\n"
    ".4byte PlayerPhase_DisplayDangerZone\n"
    ".4byte 0x00000003\n"
    ".4byte PlayerPhase_RangeDisplayIdle\n"
    ".4byte 0x0009000c\n"
    ".4byte 0x00000000\n"
    ...
    ".4byte 0x00000000\n"
    ".4byte 0x00000001\n"
    ".4byte Str_DebugRedArmy + 0x94\n"
    ".4byte 0x00000002\n"
    ".4byte ADJUSTFROMXI_MoveCameraOnSomeUnit\n"
    ".4byte 0x0001000e\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000000\n"
...
__asm__(
    ...
    ".4byte 0x00000120\n"
    ".4byte 0x00000002\n"
    ".4byte CountDownTraps\n"
    ".4byte 0x00000002\n"
    ".4byte RefreshEntityBmMapsAsRed\n"
    ".4byte 0x00000002\n"
    ".4byte GenerateTrapDamageTargets\n"
    ".4byte 0x00000002\n"
    ".4byte RecordTrapDamageDefeats\n"
    ".4byte 0x00000002\n"
    ".4byte GenerateDisplayedTrapDamageTargets\n"
    ".4byte 0x00010006\n"
    ".4byte gProcScr_TrapDamageDisplay\n"
    ".4byte 0x00000002\n"
    ".4byte ResetCountedDownTraps\n"
    ".4byte 0x00000002\n"
    ".4byte RefreshEntityBmMaps\n"
    ".4byte 0x00000002\n"
    ".4byte PostTrapExecFlag\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000000\n"
    ".4byte 0x0000000e\n"
    ".4byte 0x00000000\n"
...
__asm__(
    ...
    ".4byte GenericSelection_BackToUM\n"
    ".4byte 0x00000000\n"
    ".4byte gap_00024818 + 0x1\n"
    ".4byte ClearBg0Bg1\n"
    ".4byte 0x00000000\n"
    ".4byte gap_00024818 + 0x1d\n"
    ".4byte 0x00000000\n"
    ".4byte SummonSelection_OnSelect\n"
    ".4byte GenericSelection_BackToUM\n"
    ".4byte 0x00000000\n"
    ".4byte gap_00024818 + 0x41\n"
    ".4byte ClearBg0Bg1\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000000\n"
...
"\t.4byte 0x80000001\n"
"\t.4byte 0x100A0000\n"
"\t.4byte frontier_df4_uistuff_031_5C5DE8 + 0x50\n"
"\t.4byte frontier_df4_uistuff_031_5C5DE8 + 0x58\n"
"\t.4byte frontier_df4_uistuff_031_5C5DE8 + 0x58\n"
"\t.4byte 0x40000012\n"
"\t.4byte 0x0000C000\n"
"\t.4byte 0xC0304000\n"
...
"\t.4byte 0x00000016\n"
"\t.4byte AfterDrop_CheckTrapAfterDropMaybe\n"
"\t.4byte 0x00000002\n"
"\t.4byte AfterDrop_RefreshMapAndSprites\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000003\n"
...
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000016\n"
"\t.4byte BATTLE_HandleItemDrop\n"
"\t.4byte 0x00000002\n"
"\t.4byte BATTLE_HandleCombatDeaths\n"
"\t.4byte 0x0000000E\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000000\n"
"\t.4byte 0x00000000\n"
...
__asm__(
    ...
    ".4byte 0x00000000\n"
    ".4byte 0x00000003\n"
    ".4byte Tactician_Loop\n"
    ".4byte 0x0002000c\n"
    ".4byte 0x00000000\n"
    ".4byte 0x0001000b\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000002\n"
    ".4byte Tactician_PageFade_Init\n"
    ".4byte 0x00000003\n"
    ".4byte Tactician_PageFadeOut_Loop\n"
    ".4byte 0x00000002\n"
    ".4byte Tactician_SwapPage\n"
    ".4byte 0x00000003\n"
    ".4byte Tactician_PageFadeIn_Loop\n"
    ".4byte 0x0000000c\n"
    ".4byte 0x00000000\n"
    ".4byte 0x0003000b\n"
    ".4byte 0x00000000\n"
    ".4byte 0x00000002\n"
    ".4byte NameSelect_DrawName\n"
    ".4byte 0x00000003\n"
    ".4byte NameSelect_ConfirmLoop\n"
    ".4byte 0x0000000c\n"
    ".4byte 0x00000000\n"
    ".4byte 0x0002000b\n"
    ".4byte 0x00000000\n"
