...
u8 frontier_df4_voice_000_1F578C[] __attribute__((section(".data.frontier_df4_voice.gap0"))) = INCBIN_U8("data/sound/frontier_df4_voice_000_1F578C.bin");
...
u8 frontier_df4_voice_003_214120[] __attribute__((section(".data.frontier_df4_voice.gap3"))) = INCBIN_U8("data/sound/frontier_df4_voice_003_214120.bin");
