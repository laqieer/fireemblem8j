...
/* gFontgrp_21: a Shift-JIS font glyph (struct Glyph). The pixel bitmap is JP-
...
extern struct Glyph gFontgrp_352;

SECTION(".rodata.dat_gFontgrp_21_ref") struct Glyph gFontgrp_21 = {
    .sjisNext = (struct Glyph *)&gFontgrp_352,
    .sjisByte1 = 0x83,
    .width = 0x08,
    .bitmap =
    {
        0x00000000, 0x00000000, 0x0000CC00, 0x0003BB00,
        0x0003BBCC, 0x0000FFBB, 0x0000EFBB, 0x0000EFBB,
