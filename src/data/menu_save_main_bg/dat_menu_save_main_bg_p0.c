...
SECTION(".rodata.dat_menu_save_main_bg_p0") u8 Img_SaveMenuBG[] = INCBIN_U8("graphics/misc_gfx2/Img_SaveMenuBG.4bpp.lz");
...
SECTION(".rodata.dat_menu_save_main_bg_p0") u8 Img_MainMenuBgFog[] = INCBIN_U8("graphics/misc_gfx2/Img_MainMenuBgFog.4bpp.lz");
