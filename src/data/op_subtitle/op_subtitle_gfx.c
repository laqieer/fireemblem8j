...
SECTION(".rodata.dat_gGfx_OpSubtitle_02_ref") u8 gGfx_OpSubtitle_02[] = INCBIN_U8("graphics/misc_gfx2/gGfx_OpSubtitle_02.4bpp.lz");
SECTION(".rodata.dat_gGfx_OpSubtitle_03_ref") u8 gGfx_OpSubtitle_03[] = INCBIN_U8("graphics/misc_gfx2/gGfx_OpSubtitle_03.4bpp.lz");
SECTION(".rodata.dat_gGfx_OpSubtitle_04_ref") u8 gGfx_OpSubtitle_04[] = INCBIN_U8("graphics/misc_gfx2/gGfx_OpSubtitle_04.4bpp.lz");
SECTION(".rodata.dat_gGfx_OpSubtitle_05_ref") u8 gGfx_OpSubtitle_05[] = INCBIN_U8("graphics/misc_gfx2/gGfx_OpSubtitle_05.4bpp.lz");
SECTION(".rodata.dat_gGfx_OpSubtitle_06_ref") u8 gGfx_OpSubtitle_06[] = INCBIN_U8("graphics/misc_gfx2/gGfx_OpSubtitle_06.4bpp.lz");
SECTION(".rodata.dat_gTsa_OpSubtitle_00_ref") u8 gTsa_OpSubtitle_00[] = INCBIN_U8("graphics/misc_gfx2/gTsa_OpSubtitle_00.bin.lz");
