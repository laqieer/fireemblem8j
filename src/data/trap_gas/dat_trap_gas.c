...
SECTION(".rodata.dat_trap_gas") u8 Img_GasTrapVertical[] = INCBIN_U8("graphics/misc_gfx2/Img_GasTrapVertical.4bpp.lz");
SECTION(".rodata.dat_trap_gas") u8 Img_GasTrapHorizontal[] = INCBIN_U8("graphics/misc_gfx2/Img_GasTrapHorizontal.4bpp.lz");
...
SECTION(".rodata.dat_trap_gas") u8 Img_ArrowTrap[] = INCBIN_U8("graphics/misc_gfx2/Img_ArrowTrap.4bpp.lz");
