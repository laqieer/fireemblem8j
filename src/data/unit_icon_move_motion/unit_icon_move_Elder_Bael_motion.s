.section .rodata.unit_icon_move_Elder_Bael_motion,"a",%progbits

@ Unit-icon move (AP) motion table, editable AP-motion source ported from
@ fe8u src/data/unit_icon/const_data_unit_icon_move.s (unit_icon_move_Elder_Bael_motion).
@ Region-same: byte-identical to the JP ROM blob formerly at 81E3958
...
@ OAM attr1/attr2 data, NOT pointers — the table is fully shiftable.
	...
	.type unit_icon_move_Elder_Bael_motion, %object
...
unit_icon_move_Elder_Bael_anim_4: @ +$142
	...
	.size unit_icon_move_Elder_Bael_motion, . - unit_icon_move_Elder_Bael_motion
