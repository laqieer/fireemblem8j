.section .rodata.unit_icon_move_Swordmaster_motion,"a",%progbits

@ Unit-icon move (AP) motion table, editable AP-motion source ported from
@ fe8u src/data/unit_icon/const_data_unit_icon_move.s (unit_icon_move_Swordmaster_motion).
@ Region-same: byte-identical to the JP ROM blob formerly at 81BDEB4
