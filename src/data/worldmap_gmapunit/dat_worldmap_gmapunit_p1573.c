...
u8 Img_StatscreenHalo[] __attribute__((section(".rodata.dat_worldmap_gmapunit_p1573"))) = INCBIN_U8("graphics/gmapunit/Img_StatscreenHalo.bin.lz");
...
u8 Img_ConfigUiSprites[] __attribute__((section(".rodata.dat_worldmap_gmapunit_p1573"))) = INCBIN_U8("graphics/gmapunit/Img_ConfigUiSprites.bin.lz");
u8 Img_ConfigUiIcons[] __attribute__((section(".rodata.dat_worldmap_gmapunit_p1573"))) = INCBIN_U8("graphics/gmapunit/Img_ConfigUiIcons.bin.lz");
