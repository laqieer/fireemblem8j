 ...
 * gEfxlvupfx_0 de-opaqued to a typed AnimSpriteData[] (region-same with fe8u
 * src/data/banim-efxlvupfx.c, byte-identical to the prior .bin).
 */

SECTION(".rodata.dat_worldmap_gmapunit_p758") u16 Img_LvupApfx[] = INCBIN_U16("graphics/gmapunit/Img_LvupApfx.bin.lz");
