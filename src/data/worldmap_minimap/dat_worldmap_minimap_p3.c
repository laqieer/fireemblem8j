...
SECTION(".rodata.dat_worldmap_minimap_p3") u8 Img_EventGmap[] = INCBIN_U8("graphics/misc_gfx2/Img_EventGmap.4bpp.lz");
...
SECTION(".rodata.dat_worldmap_minimap_p3") u8 gImg_WorldmapMinimap_0[] = INCBIN_U8("graphics/misc_gfx2/gImg_WorldmapMinimap_0.4bpp.lz");
...
SECTION(".rodata.dat_worldmap_minimap_p3") u8 gTsa_WorldmapMinimap_0[] = INCBIN_U8("graphics/misc_gfx2/gTsa_WorldmapMinimap_0.bin.lz");
