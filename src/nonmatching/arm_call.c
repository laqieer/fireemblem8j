/* NON_MATCHING (m2c first-pass seed): byte source is asm/arm_call.s @ JP 0x080dc0dc
 ...
 * from the funclib US correspondence (CallARM_FillTileRect @ new-hint). It is a SEED: m2c cannot
...
/*
Skipping .incbin directive for baserom.gba, pass --incbin-dir to set a search directory
*/
