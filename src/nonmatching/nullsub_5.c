/* NON_MATCHING (m2c first-pass seed): byte source is asm/nullsub_5.s @ JP 0x08003328
 ...
 * from the funclib US correspondence (PrintProcessName @ new-hint). It is a SEED: m2c cannot
