/* NON_MATCHING (m2c first-pass seed): byte source is asm/sub_8000CD8.s @ JP 0x08000cd8
 ...
 * from the funclib US correspondence (GetGameClock @ new-hint). It is a SEED: m2c cannot
