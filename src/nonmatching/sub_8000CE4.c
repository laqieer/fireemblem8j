/* NON_MATCHING (m2c first-pass seed): byte source is asm/sub_8000CE4.s @ JP 0x08000ce4
 ...
 * from the funclib US correspondence (SetGameTime @ new-hint). It is a SEED: m2c cannot
...
extern s32 *_08000CEC;

void SetGameTime(s32 arg0)
{
    *_08000CEC = arg0;
}
