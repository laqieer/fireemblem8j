/* NON_MATCHING (m2c first-pass seed): byte source is asm/sub_80011D0.s @ JP 0x080011d0
 ...
 * from the funclib US correspondence (BG_Fill @ new-hint). It is a SEED: m2c cannot
...
extern s32 _080011EC;

void BG_Fill(s32 arg0, s32 arg1)
{
    sub_80D636C(&subroutine_arg0, arg0, _080011EC, arg1 * 0x10001);
}
