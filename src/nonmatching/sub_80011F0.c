/* NON_MATCHING (m2c first-pass seed): byte source is asm/sub_80011F0.s @ JP 0x080011f0
 ...
 * from the funclib US correspondence (RegisterBlankTile @ new-hint). It is a SEED: m2c cannot
...
M2C_UNK RegisterFillTile(s32, s32, s32);            /* extern */

void RegisterBlankTile(s32 arg0)
{
    RegisterFillTile(0, (arg0 << 5) + 0x06000000, 0x20);
}
