...
// JP 0x0800B88C - region-different sibling of fe8u Spline_SetupSegment3
// (../fireemblem8u/src/spline.c, FE8U = 0x0800B198). B-spline segment setup:
// FindSegment + per-control-point Vec/coord triple build into 3 out-structs,
// DivArm for fixed-point. No 1:1 fe8u twin name; ported from Spline_SetupSegment3.
...
int sub_800B88C(struct InputStructA * arg_0, struct InputStructB * arg_1, int * arg_2, int arg_3, s16 arg_4)
{
    s16 * r8;
