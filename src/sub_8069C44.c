...
void sub_8069C44(void *proc) {
    int r = EfxAdvanceFrameLut((s16 *)((char *)proc + 0x2c), (s16 *)((char *)proc + 0x44), (const s16 *)*(int *)((char *)proc + 0x48));
    if (r >= 0) {
        int *t4c = *(int **)((char *)proc + 0x4c);
        int *t50 = *(int **)((char *)proc + 0x50);
        int *t54 = *(int **)((char *)proc + 0x54);
        int *t58 = *(int **)((char *)proc + 0x58);
        void *p5c = *(void **)((char *)proc + 0x5c);
        SpellFx_WriteBgMap(p5c, (const u16 *)t4c[r], (const void *)t50[r]);
