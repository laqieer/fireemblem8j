...
extern u8 data_08603998[];
asm(".set data_08603998, data_08603980 + 0x18");
void sub_807069C(void *anim) {
    ...
    *(void **)((char *)q + 0x5c) = anim;
    { int z = 0;
      ...
      *(int *)((char *)q + 0x48) = (int)(frontier_df4_misc_lo_011_0E4602 + 0x2D8); *(int *)((char *)q + 0x4c) = (int)data_08603998;
      *(int *)((char *)q + 0x50) = (int)data_08603998; *(int *)((char *)q + 0x54) = (int)gEfxBgData_086039CC;
      *(int *)((char *)q + 0x58) = z; }
