...
void sub_807069C(void *anim) {
    void *q = Proc_Start((const struct ProcCmd *)0x08603980, (ProcPtr)3);
    *(void **)((char *)q + 0x5c) = anim;
    { int z = 0;
      ...
      *(int *)((char *)q + 0x58) = z; }
    SpellFx_RegisterBgPal((const u16 *)0x0877F634, 0x20); SpellFx_SetSomeColorEffect(); SetBlendConfig(1, 0xb, 7, 0);
