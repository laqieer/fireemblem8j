...
extern struct Unknown8A3E448 CONST_DATA gWorldmapPlayerInterface_0[];

// clang-format off

extern s8 CONST_DATA gGMapPIShowOffsetTableA[];



extern s8 CONST_DATA gGMapPIShowOffsetTableB[];
